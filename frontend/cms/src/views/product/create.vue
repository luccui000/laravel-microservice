        ...
        <div class="row">
          <div class="col-8">
            <el-form-item label="Tên sản phẩm" prop="name" >
              <el-input v-model="product.name" size="medium" ></el-input>
            </el-form-item>
            <el-form-item label="Mô tả" prop="name" >
              <el-input v-model="product.description" size="medium" ></el-input>
            </el-form-item>
            <div class="my-3"></div>  
            <el-select v-model="product.category_id" class="mr-2" placeholder="Chọn danh mục" size="medium">
              <el-option
            ...
            <el-select v-model="product.supplier_id" class="mr-2" placeholder="Chọn danh mục" size="medium">
              <el-option
            ...
            <el-select v-model="product.brand_id" class="mr-2" placeholder="Chọn danh mục" size="medium">
              <el-option
            ...
            <div class="my-3"></div>
            <el-checkbox v-model="product.is_hot">Sản phẩm hot</el-checkbox> 
            <el-checkbox v-model="product.is_new">Sản phẩm mới</el-checkbox> 
            <el-checkbox v-model="product.is_unlimited">Số lượng không giới hạn</el-checkbox>  
            <div class="my-3"></div> 
            <l-editor
            ...
            />
            <div class="my-3"></div>
            <el-checkbox v-model="product.has_variant">Biến thể sản phẩm</el-checkbox>
            <div class="my-3"></div>
            <div class="d-flex" v-if="product.has_variant">
              ...
              <div class="row">
                <div class="col-6">
                  <el-form-item label="Giá sản phẩm" prop="name" >
                    <el-input v-model="product.price" size="medium" ></el-input>
                  </el-form-item>
                </div>
                <div class="col-6">
                  <el-form-item label="Giá sản phẩm" prop="name" >
                    <el-input v-model="product.sell_price" size="medium" ></el-input>
                  </el-form-item>
                </div>
              </div>
            </div>
